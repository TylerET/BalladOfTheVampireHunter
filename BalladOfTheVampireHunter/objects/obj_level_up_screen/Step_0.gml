...
if (mouse_check_button_pressed(mb_left)|| keyboard_check_pressed(ord("1")) || keyboard_check_pressed(ord("2")) || keyboard_check_pressed(ord("3")) || keyboard_check_pressed(ord("4"))) {
    ...
    if ((mouse_x_pos > card1_x && mouse_x_pos < card1_x + card_width &&
        mouse_y_pos > card_y && mouse_y_pos < card_y + card_height)|| keyboard_check_pressed(ord("1"))) {
    ...
    if ((mouse_x_pos > card2_x && mouse_x_pos < card2_x + card_width &&
        mouse_y_pos > card_y && mouse_y_pos < card_y + card_height)|| keyboard_check_pressed(ord("2"))) {
    ...
    if ((mouse_x_pos > card3_x && mouse_x_pos < card3_x + card_width &&
        mouse_y_pos > card_y && mouse_y_pos < card_y + card_height)|| keyboard_check_pressed(ord("3"))) {
    ...
    if ((mouse_x_pos > card4_x && mouse_x_pos < card4_x + card_width &&
        mouse_y_pos > card_y && mouse_y_pos < card_y + card_height)|| keyboard_check_pressed(ord("4"))) {
